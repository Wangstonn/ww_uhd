...
//     double rss_dbm = estim::CalcRss(h_hat_fwd)+30;
...
//     std::cout << std::dec << "Average symbol length: " << avg_sym_len/(n_iters*mmio::kPktLen) << std::endl;
