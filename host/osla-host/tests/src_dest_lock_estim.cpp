...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    uint32_t sync_start_periods = (0xFFFF << 16) + 0x7FFF; //min is 0x000F
    ...
    double rss_adc_dbm = 20*log10(std::abs(h_hat_fwd) * std::pow(2,4) * std::pow(2,-13)) - 10*log10(50) - 30;

    std::cout << std::dec << "D_test= " << D_test << ", ";
    std::cout << "D_hat_fwd= " << D_hat_fwd << ", ";
    std::cout << "EsN0= " << EsN0 << ", ";
    std::cout << "rss_adc (dbm)= " << rss_adc_dbm << ", ";
