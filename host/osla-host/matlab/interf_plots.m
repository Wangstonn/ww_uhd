...
figure;
plot(EsNidb, N./TavgClairvoyant, 'm--x', 'LineWidth', 1.5, 'MarkerSize', 6.5, 'DisplayName', 'Simulated OSLA-FIM (Perfect CSI) (AWGN Interference)');
hold on;

EsNidb = [-15 -10  -5   0   5  10  15  20  25  30  35];
TavgInterMitigation = [50.7537      50.2384      50.1158      50.1054      49.7091      46.4529      39.3266      34.1723      32.5293      31.9311      32.1081];
plot(EsNidb, N./TavgInterMitigation, 'b--x', 'LineWidth', 1.5, 'MarkerSize', 6.5, 'DisplayName', 'Simulated OSLA-FIM (Algorithm 1) (AWGN Interference)');
...
plot(EsNidb, N./avg_sym_len, 'b-o', 'LineWidth', 2, 'MarkerSize', 6.5,  'DisplayName', 'Wireless OSLA-FIM (Algorithm 1) (AWGN Interference)');
