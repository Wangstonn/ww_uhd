...
class GFSK_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "GFSK_test")
        ...
        self.uhd_usrp_source_0.set_bandwidth(160000000, 0)
        ...
        self.blocks_moving_average_xx_0 = blocks.moving_average_cc(length, 1/length, 4000, 1)
        self.blocks_freqshift_cc_0_0 = blocks.rotator_cc(2.0*math.pi*-F_IF/samp_rate)
        ...
        self.connect((self.blocks_freqshift_cc_0_0, 0), (self.blocks_moving_average_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_freqshift_cc_0_0.set_phase_inc(2.0*math.pi*-self.F_IF/self.samp_rate)
