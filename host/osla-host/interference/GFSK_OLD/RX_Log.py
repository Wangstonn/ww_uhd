...
import time
import RX_Log_epy_block_0 as epy_block_0  # embedded python block



from gnuradio import qtgui

class RX_Log(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RX_Log")
        ...
        self.epy_block_0 = epy_block_0.logging_block(file_path="/tmp/samnolan/RX_samples.csv", sample_limit=80000000)
...
def main(top_block_cls=RX_Log, options=None):
