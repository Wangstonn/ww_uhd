...
class blk(gr.sync_block):  # other base classes are basic_block, decim_block, interp_block
    ...
    def __init__(self, sampling_rate = 32000, noise_rate = 1.0, noise_length = 1.0, Es_Ni = 0, Pr = 0, F_of = 0, analog_gain = 0):  # only default arguments here
        """
        Parameters:
        ...
        A_tx = 10**(analog_gain/20)    

        self.G = (1/A_tx)*np.sqrt(1/(fbin_width*np.sum(PSD[PSD_i_low:PSD_i_high,0])))
