...
class GFSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("BLE_Interference")
        ...
        self.epy_block_0 = epy_block_0.blk(sampling_rate=samp_rate, noise_rate=200, noise_length=.002, Es_Ni=20, Pr=-90, F_of=0, analog_gain=0)
