...
class Reciever(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_short*2, '/tmp/samnolan/c16_BLE_constAmp_EsNi0dB_10M.bin', False)
        ...
        self.connect((self.uhd_usrp_source_0_0, 0), (self.blocks_vector_to_stream_0, 0))
