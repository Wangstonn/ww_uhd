...
class BLE_Interference(gr.top_block):
    ...
    def __init__(self, ch_gain=20, estPr=-86.98, targPi=-125, tx_freq=2.4e9):
        ...
        self.psd_file_path = psd_file_path = os.path.join(os.path.dirname(__file__), "../../matlab/BLEwaveform/BLE_PSD.csv") #"/n/deer/z/samnolan/ww_uhd/host/osla-host/interference/matlab/BLEwaveform/BLE_PSD.csv"
